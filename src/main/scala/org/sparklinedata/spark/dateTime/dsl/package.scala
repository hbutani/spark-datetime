...
package object dsl {
  ...
  implicit class DateExpression private[dsl](val expr : Expression) {
    ...
    def withCenturyOfEra(centuryOfEra : Int): DateExpression = new DateExpression(fun("withCenturyOfEra",
      Literal(centuryOfEra)))

    def withYearOfEra(yearOfEra : Int):  DateExpression = new DateExpression(fun("withYearOfEra", Literal(yearOfEra)))

    def withYearOfCentury(yearOfCentury : Int): DateExpression = new DateExpression(fun("withYearOfCentury",
      Literal(yearOfCentury)))

    def withYear(year : Int): DateExpression = new DateExpression(fun("withYear", Literal(year)))

    def withWeekyear(weekyear : Int): DateExpression = new DateExpression(fun("withWeekyear", Literal(weekyear)))

    def withMonthOfYear(monthOfYear : Int): DateExpression = new DateExpression(fun("withMonthOfYear", Literal(monthOfYear)))

    def withWeekOfWeekyear(weekOfWeekyear : Int): DateExpression = new DateExpression(fun("withWeekOfWeekyear",
    ...
    def withDayOfWeek(dayOfWeek : Int): DateExpression = new DateExpression(fun("withDayOfWeek", Literal(dayOfWeek)))

    def withHourOfDay(hourOfDay : Int): DateExpression = new DateExpression(fun("withHourOfDay", Literal(hourOfDay)))

    def withMinuteOfHour(minute : Int): DateExpression = new DateExpression(fun("withMinuteOfHour", Literal(minute)))

    def withSecondOfMinute(second : Int): DateExpression = new DateExpression(fun("withSecondOfMinute",
      Literal(second)))

    def withMillisOfDay(millisOfDay : Int): DateExpression = new DateExpression(fun("withMillisOfDay",
      Literal(millisOfDay)))

    def withMillisOfSecond(millis : Int): DateExpression = new DateExpression(fun("withMillisOfSecond",
      Literal(millis)))
